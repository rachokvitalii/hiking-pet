...
import { gearCatalogItems, gearCategories, packingListItems, packingLists } from "./packing-schema";
...
export const gearCatalogItemsRelations = relations(gearCatalogItems, ({ one, many }) => ({
