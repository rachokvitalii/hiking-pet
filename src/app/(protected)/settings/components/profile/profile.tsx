  ...
  const form = useForm<ProfileSchema>({
    ...
    values: me.data
      ? {
          ...
          experienceLevel:
            (me.data.experienceLevel as ProfileSchema["experienceLevel"]) ??
            null,
          preferredTripDuration:
            (me.data
              .preferredTripDuration as ProfileSchema["preferredTripDuration"]) ??
            null,
