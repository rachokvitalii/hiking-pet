  ...
  return (
    <NavigationMenuPrimitive.Link
      ...
      className={cn(
        ...
        "data-[active]:bg-primary data-[active]:text-primary-foreground data-[active]:hover:bg-primary/90 data-[active]:hover:text-primary-foreground data-[active]:shadow-xs",
        className,
      )}
      {...props}
    />
